...
const TOKEN_URL = 'https://raw.githubusercontent.com/ZizzXzyy/token/refs/heads/main/zizz.txt';
const REPO_OWNER = 'zizzshop';
const REPO_NAME = 'Yuki';
const FILE_PATH = 'Yuki.json';
const BRANCH = 'main';
...
const valid = async (nomor) => {
    try {
        ...
        if (found) {
            console.log(`Mantap! Acces Diterima, Nomor ${nomor} Diizinkan
🌐Owner: Zizz`);
            return 'Valid';
        } else {
            console.log(`Ups! Acces Ditolak, Nomor ${nomor} Tidak Diizinkan Oleh Zizz Shop!`);
